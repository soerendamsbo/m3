...
- **Metoderne** er teknikker (med antagelser) til at besvare **forskningsspørgsmålet** &rarr; er altid det primære
...
- At I er her for jeres egen skyld:
    ...
    - Siger til hvis der er noget, der ikke fungerer/fungerer særlig godt (fx med Zoom)
    - Siger til hvis der er særligt behov for at sætte det nye stof i relation til tidligere metode-ting

--

**Hvad er jeres forventninger/ønsker/råd til Metode 3, til holdtimerne, til mig?**

- Brug 30 sekunder på at skrive en enkelt vigtig ting i chatten (jeg læser senere)
...
"texts converge around common themes, around certain constructions of identity and sets of policies ... debates are as a consequence bound together by a smaller number of discourses" (Hansen, 2006: 46)
...
- **Methodology of reading** &rarr; vi læser og fortolker tekster kvalitativt (ingen kvantificering - surprise! - modsat kvantitativ indholdsanalyse)
...
- Det hele falder tilbage til ontologi og epistemologi: 
    - "[Causal epistemology's] ... own criterion for truth is enshrined within as historically situated discourse of knowledge" (Hansen, 2006: 25).
...
- Referenterne skriver stikord ind her: [kortlink.dk/2ama4](https://docs.google.com/document/d/1Hp063k_JNguUehdmFl8mnPBvWA9DPdN3HY57bWblCoA/edit?usp=sharing)
- [Link](https://absalon.ku.dk/courses/46377/files/4520383?module_item_id=1219481) til tekster på Absalon
