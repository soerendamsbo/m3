...
- Recap af **vigtige pointer** fra forelæsning og pensum &rarr; så sætter det sig bedre fast
    - Og det er ofte godt at høre flere alternative vinkler og formuleringer
...
- **Friere rum** til at diskutere, reflektere, hjælpe hinanden, stille "dumme" spørgsmål (= gode spørgsmål)
...
- Nogle gange kan en diskurs være markant og springe os i øjnene (eksempler: politiske taler eller "menneskets natur")
...
- "**basale diskurser**" (idealtyper) strukturer politiske debatter og deres "underdiskurser" 
    - Tekster konvergerer "around **common themes**, around certain **constructions of identity** and **sets of policies** considered viable, desirable or necessary ... **bound together by a smaller number of discourses**" (Hansen, 2006: 46)
    - *Idealtyper*
...
- Sproget findes mellem personer, bundet til tid og sted (indlejret i en specifik historie og social sammenhæng)
...
- Diskurser vil altid forsøge at etablere/stabilisere sig (deres specifikke repræsentation), men vil altid være udfordret af andre (mod)diskurser

--

&rarr; **Helt kort**: Politik og identitet er gensidigt konstituerende gennem diskursive processer/sproglige repræsentationer, som vi kan afdække i tekster (billeder, lyd, film, etc.)
...
- **Identiteter er relationelle**: 
    ...
    - "Although the two processes [linking og differentiering] can be seperated analytically, it is important to stress that they are both part and parcel of the process of identity construction" (Hansen 2006: 17 ).
...
- Ad 3 (**kausale spørgsmål**): Nej, man besvarer ikke kausale spørgsmål &rarr; fundamentalt anderledes tilgang (konstitutiv teori). Men stadigvæk interesseret i relationer mellem "ting" i den politiske verden.
...
- Se evt. Tabel 4.2 i Hansen (2006) for inspiration
...
- Gælder i højeste grad også diskursanalyse (fx afhænger de relevante tekster og diskurser på et område direkte af problemstillingen)
...
- Hvilke **identiteter** artikuleres i materialet? Led efter sæt af "os" og "dem" (diskursive dikotomier) 
...
- Hav blik for hvordan udsagnene er produceret (genre)

- Hav blik for dynamikker/(u)stabilitet: identiteter kan få og miste betydning over tid (dis/appearance). Eller de kan også konstrueres ift. sig selv over tid (eksempel: EU)
...
- **Temporal**: Forandring, potentiale, udvikling, progression, stagnation mv.

- **Etisk** (responsibility): Hvor placeres ansvarlighed (for hvad/hvem)?
...
- Hvilke politiske dynamikker afføder den diskursive opposition: fx afvisning eller tilpasning?
...
- Vi studerer politiske diskurser gennem kvalitativ analyse af tekster og andre kvalitative data
