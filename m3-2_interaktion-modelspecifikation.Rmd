...
- Her vil en interaktion være den korrekte modelspeciﬁkation. Altså en interaktiv model.
...
Der ﬁndes en del begreber, som dækker over dagens tema:
...
- Dvs: Der kan givetvis være niveauer på Z moderationen ikke er signiﬁkant!
...
Lad os visualisere! (altid en god id´e med interaktioner). Men først denne:
...
Bl.a. fordi hovedleddene nærmest pr. deﬁnition er korreleret med interaktionsleddet, betyder det noget for estimatet af interaktionsleddet. Det betyder, at vi meget ofte vil få et biased interaktionsestimat, hvis man kun bruger #.
...
- Give en bedre id´e om den kausale mekanismen
