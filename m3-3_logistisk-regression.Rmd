...
Husk at med en regression forsøger vi, at ﬁnde den model som bedst beskriver data.
...
Husk: med en regression forsøger vi, at ﬁnde den model som bedst beskriver forholdet mellem X og Y.
...
- Det betyder, at vi estimerer, at der er 66,7% sandsynlighed for at ﬁnde observationen 1-tal i populationen.
...
- Formål: ﬁnde den koeﬃcient, der er mest sandsynlig, givet det data, man har.
...
- Forsøger Stata sig med en række værdier for b, indtil den ﬁnder den b, der har den laveste log likelihood.
...
- Likelihood Ratio: Kollektiv signiﬁkans (ligesom F-statistikken i OLS).
...
- ”At ﬁnde den gennemsnitlige hældning for den s-formede kurve”

**Marginal Effect at the Mean (MEM)**

- Marginale effekter ved gennemsnittet (eller en anden væsentlig niveau på x).

- At vælge et speciﬁk punkt, og ﬁnde hældningen her.
...
- Tolk på interaktionsleddet ved at regne marginale effekter. Men husk på at marginale effekter ikke siger noget om hele interaktionens signiﬁkans ved OLS-regression.
...
- Modellen er korrekt speciﬁceret (altså ikke udeladt variabel bias etc.)
