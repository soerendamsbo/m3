...
- Hvordan udfører vi det i **Stata** og fortolker output?
    - eksempel fra Mehmetoglu & Jakobsen (2016)
...
- Bagefter hører vi et svar fra **gruppe 1/6 på spgm. 1**, fra **gruppe 2/7 på spgm. 2**, fra **gruppe 3/8 på spgm. 3**, fra **gruppe 4/9 på spgm. 4** og fra **gruppe 5/10 på spgm. 5**

***

1. Hvad er et multilevel-problem? Giv et hypotetisk eksempel på et problem eller en hypotese (Hox, 2010, pp. 6-7)
...
4. Hvad menes der med "aggregering" og "disaggregering"? (Hox, 2010, pp. 2-4)

5. Hvad er *det statistiske problem* ved at aggregere hhv. disaggregere data? Hvad sker der med *N*? (Hox, 2010, p. 3)
